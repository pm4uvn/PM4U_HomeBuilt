...
const TABS = [
  { href: "/equipment", label: "Thiết bị dự án" },
  { href: "/equipment/catalog", label: "📖 Danh mục tham khảo" },
];

/** Tab điều hướng giữa Thiết bị dự án và Danh mục tham khảo — 2 trang cùng module, khác route */
